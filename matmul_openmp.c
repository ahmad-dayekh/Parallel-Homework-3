...
int main() {
    ...
    printf("Matrix Multiplication (Sequential): %f seconds\n", dtime);

    dtime = omp_get_wtime();
    mm_omp(A,B,C, n);
    dtime = omp_get_wtime() - dtime;
    printf("Matrix Multiplication with OpenMP: %f seconds\n", dtime);

    dtime = omp_get_wtime();
    mmT(A,B,C, n);
    dtime = omp_get_wtime() - dtime;
    printf("Matrix Multiplication with Transposed B (Sequential): %f seconds\n", dtime);

    dtime = omp_get_wtime();
    mmT_omp(A,B,C, n);
    dtime = omp_get_wtime() - dtime;
    printf("Matrix Multiplication with Transposed B and OpenMP: %f seconds\n", dtime);
